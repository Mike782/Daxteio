...
PacketHandler.prototype.setNickname = function(text) {
    ...
    */
    ...
    let lockedName = [
        ...
        "::ffff:127.0.0.1" // add ::ffff: before ip - multiogar sometimes reads different ips differently
    ]

    if (this.socket._socket != undefined) {
        if (arrayContains(this.socket._socket.remoteAddress, lockedName)) {
            Logger.info("Locked Name User Connected");
        } else {
